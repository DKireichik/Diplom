...
//        basketButton.addTarget(HomeCollectionViewCellBooks.self, action: #selector(addToBasket), for: .touchUpInside)
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            basketButton.topAnchor.constraint(equalTo: price.bottomAnchor, constant: 15),
            basketButton.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor,constant: 10),
            basketButton.trailingAnchor.constraint(equalTo:  view.safeAreaLayoutGuide.trailingAnchor,constant: -10),
        ])
